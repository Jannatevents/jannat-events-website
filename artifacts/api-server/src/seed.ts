...
export async function ensureSeeded() {
  ...
  const seededEvents = await db.insert(eventsTable).values([
    { title: "Jannat: Midnight in Mumbai", slug: "midnight-in-mumbai", date: "2026-10-17", startTime: "22:00", endTime: "02:30", venue: "Rebel", address: "11 Polson Street", city: "Toronto", province: "ON", description: "<p>A cinematic Bollywood night built for the city after dark. Expect beloved anthems, new-school edits, and a dance floor that never loses the plot.</p>", poster: images[0], ticketUrl: "https://www.eventbrite.ca/", instagramUrl: "https://www.instagram.com/jannatcanada/", status: "UPCOMING", featured: true, ageRestriction: "19+", dressCode: "Elevated evening", organizer: "Jannat Events" },
    { title: "Jannat Vancouver: Noor", slug: "vancouver-noor", date: "2026-11-07", startTime: "21:30", endTime: "02:00", venue: "Fortune Sound Club", address: "147 E Pender Street", city: "Vancouver", province: "BC", description: "<p>A luminous night of Bollywood, Punjabi and global club sounds in the heart of Vancouver.</p>", poster: images[1], ticketUrl: "https://www.eventbrite.ca/", status: "UPCOMING", featured: false, ageRestriction: "19+", organizer: "Jannat Events" },
    { title: "Jannat Montréal: Raat", slug: "montreal-raat", date: "2026-11-28", startTime: "22:00", venue: "New City Gas", address: "950 Ottawa Street", city: "Montréal", province: "QC", description: "<p>Old favourites, future classics, and Montréal energy from doors to close.</p>", poster: images[2], ticketUrl: "https://www.eventbrite.ca/", status: "UPCOMING", featured: false, ageRestriction: "18+", organizer: "Jannat Events" },
    { title: "Jannat: Summer After Dark", slug: "summer-after-dark", date: "2026-07-11", startTime: "22:00", venue: "The Pearl", address: "184 Pearl Street", city: "Toronto", province: "ON", description: "<p>The summer chapter: warm nights, loud choruses, and a room full of familiar faces.</p>", poster: images[3], status: "PAST", featured: false, ageRestriction: "19+", organizer: "Jannat Events" },
  ]).returning();
