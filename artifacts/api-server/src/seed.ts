...
export async function ensureSeeded() {
  ...
  await db.insert(siteSettingsTable).values({ id: 1, instagramUrl: "https://www.instagram.com/jannatcanada/", facebookUrl: "https://www.facebook.com/profile.php?id=61571229590318", tiktokUrl: null, contactEmail: "contactthejannat@gmail.com", cities: ["Toronto", "Vancouver", "Montréal", "Calgary"] });
}